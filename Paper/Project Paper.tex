...
\begin{align*}
    ...
    \dot{P} &= Y_{P/S} (-\dot{S}),
\end{align*}
where $Y_{X/S}$ denotes the grams of biomass of yeast per gram of sugar, and $Y_{P/S}$ denotes the product yield of yeast per gram of sugar. The plot of the solution is given in \ref{fig:monod_categorical}.
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.4]{mcrm.png}
