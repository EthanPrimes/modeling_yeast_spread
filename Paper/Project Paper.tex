...
\begin{figure}[htbp]
    ...
    \caption{The monod categorical model.}
...
\end{center}
\caption{A KM mechanistic model plot.}
...
\par The simple model fit the real-world data \cite{mechanistic} surprisingly well. \ref{fig:images/simple_compartmental.png}
...
\subsection*{MacArthur Consumer-Resource}
Unfortunately we were unable to find real-world data which we could use to evaluate this model quantitatively. Instead we will pick reasonable parameter values and evaluate the results qualitatively. Using parameters in the ranges in \ref{tab:param_vals}, we obtain \ref{fig:mcrm}.
