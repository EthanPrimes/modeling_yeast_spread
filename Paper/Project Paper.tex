...
\;
\par There are four primary ingredients in bread dough: flour, water, salt, and yeast. Once water is mixed with flour, enzymes activate, including alpha-amylase and beta-amylase. These enzymes break up the long starch chains in the flour, quickly converting these into glucose and maltose. These sugars, unlike starch itself, are edible by yeast. \cite{bread_chemistry_1}
...
\par Some of the models in this paper sought to incorporate this two-phase structure.
