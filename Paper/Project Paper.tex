...
We now seek to incorporate the Monod equation into a compartmental model. The Monod equation models the growth of a microorganism based on the concentration of a limiting substance. \cite{monod_1}
...
\hline
$Y_0$ & 5.3 & $\frac{g_Y}{L}$ & Biomass of dry yeast per liter of dough \\
$O_0$ & 0.25 & $\frac{mmol}{L}$ & Count of $O_2$ per liter of dough \\
$S_0$ & 3-5 & $\frac{GGE}{L}$ & Grams of Glucose-Equivalent per liter of dough \\
$C_0$ &  & $\frac{mol}{L}$ & Count of $CO_2$ per liter of dough \\
$K_O$ & 0.01 - 0.03 & $\frac{mmol}{L}$ & Half saturation for Oxygen \\
$K_S$ & 0.1 - 0.5 & $\frac{GGE}{L}$ & Half saturation for Sugar \\
$P_S$ & 10 - 20 & $\frac{g_S}{L}$ & Carrying capacity for sugar \\
$r_S$ &  & $\frac{1}{h}$ & Sugar logistic growth rate \\
$w_S^{aer}$ & 0.45 - 0.55 & $\frac{g_Y}{g_S}$ & aerobic ATP yield, very efficient
$w_S^{ana}$ & 0.1 & $\frac{g_Y}{g_S}$ & anaerobic ATP yield, inefficient
$w_O$ & 0.016 & $\frac{g_Y}{mmol}$ & Oxygen yield
$c_S$ & &  $\frac{L}{g_Yh}$ & Maximum Sugar uptake, the fastest yeast processes sugar per unit biomass
$c_O$ & & $\frac{L}{g_Yh}$ & Oxygen uptake, how quickly yeast processes Oxygen per unit biomass
\hline
\end{tabular}
