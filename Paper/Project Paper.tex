...
\par This model, which was by far the simplest of the models we implemented, performed surprisingly well quanititatively. It sadly does not incorporate the two-phase structure that some of the other models do, but each category's graph looks similar to the data it trained on.
