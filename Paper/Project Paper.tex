...
\par Once water is mixed with flour, enzymes from the flour activate, including alpha-amylase and beta-amylase. These enzymes break up the long starch chains in the flour, quickly converting these into glucose and maltose. These sugars, unlike starch itself, are edible by yeast.

\par Yeast is a type of single-celled fungus that produces \ce{CO_2}.

\cite{bread_chemistry_1}
...
\par In the second phase, which occurs once the oxygen in the bread is exhausted, yeast consumes glucose and begins producing ethanol instead of water as a biproduct. The yeast still produces \ce{CO_2} as a byproduct, but it produces it at a slower rate.
\[
